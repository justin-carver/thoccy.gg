...
let english100 = `<layout>
    ...
    <row>
        <keyGroup>
            <key glyph="CAPS" keyCode="CapsLock" size="width-4"/>
    ...
    <row>
        <keyGroup>
            <key glyph="SHIFT" keyCode="ShiftLeft" size="width-5"/>
            <key glyph="Z" keyCode="KeyZ" size="width-1"/>
            <key glyph="X" keyCode="KeyX" size="width-1"/>
            <key glyph="C" keyCode="KeyC" size="width-1"/>
            <key glyph="V" keyCode="KeyV" size="width-1"/>
            <key glyph="B" keyCode="KeyB" size="width-1"/>
            <key glyph="N" keyCode="KeyN" size="width-1"/>
            <key glyph="M" keyCode="KeyM" size="width-1"/>
            <key glyph="," keyCode="Comma" secondGlyph="<" size="width-1"/>
            <key glyph="." keyCode="Period" secondGlyph=">" size="width-1"/>
            <key glyph="/" keyCode="Slash" secondGlyph="?" size="width-1"/>
            <key glyph="SHIFT" keyCode="ShiftRight" size="width-6"/>
        </keyGroup>
        <keyGroup>
            <key glyph="" keyCode="" size="blank"/>
            <key glyph="⯅" keyCode="ArrowUp" size="width-1"/>
            <key glyph="" keyCode="" size="blank"/>
        </keyGroup>
        <keyGroup>
            <key glyph="1" keyCode="Numpad1" size="width-1"/>
            <key glyph="2" keyCode="Numpad2" size="width-1"/>
            <key glyph="3" keyCode="Numpad3" size="width-1"/>
            <key glyph="ENT" keyCode="NumpadEnter" size="width-1"/>
        </keyGroup>
    </row>
    <row>
    <keyGroup>
        <key glyph="CTRL" keyCode="ControlLeft" size="width-2"/>
        <key glyph="WIN" keyCode="OSLeft" size="width-2"/>
        <key glyph="ALT" keyCode="AltLeft" size="width-2"/>
        <key glyph="SPACE" keyCode="Space" size="width-10"/>
        <key glyph="ALT" keyCode="AltRight" size="width-2"/>
        <key glyph="FN" keyCode="OSRight" size="width-2"/>
        <key glyph="MENU" keyCode="ContextMenu" size="width-2"/>
        <key glyph="CTRL" keyCode="ControlRight" size="width-2"/>
    </keyGroup>
    <keyGroup>
        <key glyph="⯇" keyCode="ArrowLeft" size="width-1"/>
        <key glyph="⯆" keyCode="ArrowDown" size="width-1"/>
        <key glyph="⯈" keyCode="ArrowRight" size="width-1"/>
    </keyGroup>
    <keyGroup>
        <key glyph="0" keyCode="Numpad0" size="width-4"/>
        <key glyph="." keyCode="NumpadDecimal" size="width-1"/>
        <key glyph="ENT" keyCode="NumpadEnter" size="width-1"/>
    </keyGroup>
</row>
</layout>`;
