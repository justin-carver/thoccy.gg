...
const Key = (props) => {
    ...
    return (
        <motion.div className={`Thoccy__Key Thoccy__Key--untouched Thoccy__Key--${props.size}`}
                    id={props.keyCode} initial="initial" animate="animate" variants={spawnVariant} whileHover={props.size === 'blank' ? "" : "hover"}>
